...
const Sidebar = ({ firstName, lastName, userType, onMenuSelect }) => {
  return (
    <div
      id="sidebar"
      className="bg-white h-[calc(100vh-4rem)] md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out"
      style={{ top: "4rem" }} // Adjust for Navbar height
    >
      <div className="space-y-6 md:space-y-10 mt-10">
        {/* User Profile */}
        <div id="profile" className="space-y-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 text-center">{userType}</p>
          </div>
        </div>
